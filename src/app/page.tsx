    ...
    <div className="relative flex items-center justify-center min-h-[calc(100vh-4rem)] overflow-hidden" >
      <StarTrail />
       <div
        ...
        style={{
          background: `radial-gradient(75px circle at ${mousePosition.x}px ${mousePosition.y}px, hsl(var(--primary) / 0.1), transparent 80%)`,
        }}
      />
       <div
        className="pointer-events-none fixed inset-0 z-30 transition duration-300"
        style={{
          background: `radial-gradient(75px circle at ${mousePosition.x + 20}px ${mousePosition.y + 20}px, hsl(var(--accent) / 0.1), transparent 80%)`,
        }}
      />
